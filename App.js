...
import SmartChat from './Pages/Client/SmartChat';
import TicketingSystemCS from './Pages/Client/TicketingSystemCS';
      ...
      <UserProvider>
        ...
        <Routes>
         ...
         <Route path='/chat' element={<Chat/>}></Route>
          ...
          <Route path='/editticketpage/:ticketId' element={<EditTicketPage/>}></Route>
          <Route path='/viewticketpage/:ticketId' element={<ViewTicketPage/>}></Route>
          <Route path='/ServiceLevelAgreement/:userType' element={<ServicelevelAgreement/>}></Route>
          <Route path='/CustomerSurvey' element={<CustomerSurvey/>}></Route>
          <Route path='/ServiceAnalytics' element={<ServiceAnalytics/>}></Route>
          <Route path='/SmartChat' element={<SmartChat/>}></Route>
         <Route path='TicketingSystemCS' element={<TicketingSystemCS/>}></Route>
